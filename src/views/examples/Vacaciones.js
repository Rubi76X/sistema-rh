          ...
          <div className="col mt-5">
            <Card className="shadow">
              <CardHeader className="border-0">
                <h3 className="mb-0 text-xl">Vacaciones</h3>
                <div className="d-flex mt-4 justify-content-between lign-items-center">
                        <div className="d-flex">
                        <div className="ausencias-days mr-3">
                            <h5 className="mb-0">Días disponibles</h5>
                            <p className="text-lg"><span>22</span>/22</p>
                        </div>
                        <div className="ausencias-days mr-3">
                            <h5 className="mb-0">Por confirmar</h5>
                            <p className="text-lg">0</p>
                        </div>
                        <div className="ausencias-days mr-3">
                            <h5 className="mb-0">Confirmados</h5>
                            <p className="text-lg">0</p>
                        </div>
                        <div className="ausencias-days">
                            <h5 className="mb-0">Disfrutados</h5>
                            <p className="text-lg">0</p>
                        </div>
                        </div>
                        <div>
              ...
              <div className="ml-4 mt-5">
                  <h4 className="text-lg">Historial de vacaciones</h4>
              </div>
              <div className="container-vacaciones-nota">
                  <h4>No hay vacaciones previstas</h4>
                  <p>Cuando solicites vacaciones podrás ver aquí toda la información sobre tu solicitud</p>
              </div>
